...
class TripController {
    ...
    def searchForm() {
      def results = Trip.findAllByOriginAndDestination(params.origin, params.destination)
      [results:results]
    }
    ...
    def search() {
      def results = Trip.findAllByOriginAndDestination(params.search, params.search)
      [results:results]
    }
